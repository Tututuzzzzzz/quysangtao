  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        problemDescription: formData.problemDescription?.trim() || 'Tối ưu hoá quy trình làm việc và giải quyết vướng mắc thực tế tại đơn vị.',
        proposedSolution: formData.proposedSolution?.trim() || 'Triển khai giải pháp ứng dụng công nghệ và chuẩn hoá các bước thực thi.',
